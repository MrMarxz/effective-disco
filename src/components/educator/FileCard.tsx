...
import EducatorFileDetailsDialog from './details-dialog';
...
const EducatorFileCard: React.FC<FileCardProps> = ({
  files,
  onDownload,
  onToggleDisplay,
  onReport,
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="w-full">
                  <div className="flex flex-row justify-between">
                    ...
                    <EducatorFileDetailsDialog fileId={file.id} />
                  </div>
...
export default EducatorFileCard;